<script>
	...
	import { cartItemsStore } from '$lib/services/cart.service';
...
<nav class="sticky top-0 z-10 bg-[#282828] text-white">
	<div class="mx-auto">
		<div class="flex justify-between items-center py-4">
			<div>
				<a class="mx-5 font-semibold text-xl" href="/">E-Commerce</a>
			</div>
			<div class="flex items-center gap-6 m-auto">
				<a class="hover:underline underline-offset-4" href="/products">Products</a>
				<a class="hover:underline underline-offset-4" href="/orders">Orders</a>
			</div>
